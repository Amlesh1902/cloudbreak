...
public class OperationDescriptions {
    ...
    public static class StackOpDescription {
        ...
        public static final String UPDATE_LOAD_BALANCER_DNS_IN_WORKSPACE = "update load balancer dns in workspace";
        ...
        public static final String CHECK_ATLAS_UPDATED = "Checks if the Atlas service on the cluster is up to date with recent user actions.";
    }
