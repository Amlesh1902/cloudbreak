...
public class StackV4Controller extends NotificationController implements StackV4Endpoint {
    ...
    @Override
    @InternalOnly
    public void rotateSaltPasswordInternal(Long workspaceId, String crn, @InitiatorUserCrn String initiatorUserCrn) {
        stackOperations.rotateSaltPassword(NameOrCrn.ofCrn(crn), restRequestThreadLocalService.getRequestedWorkspaceId());
    }
