...
import static com.sequenceiq.cloudbreak.core.flow2.cluster.datalake.atlas.CheckAtlasUpdatedEvent.CHECK_ATLAS_UPDATED_EVENT;
...
public class CheckAtlasUpdatedFlowEventChainFactory implements FlowEventChainFactory<CheckAtlasUpdatedTriggerEvent> {
    ...
    public FlowTriggerEventQueue createFlowTriggerEventQueue(CheckAtlasUpdatedTriggerEvent event) {
        ...
        flowEventChain.add(new CheckAtlasUpdatedTriggerEvent(CHECK_ATLAS_UPDATED_EVENT.event(), event.getResourceId()));
