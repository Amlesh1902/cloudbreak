...
public class CloudWatchService {
    ...
    public GetMetricStatisticsResult getAWSMetricResult(CloudCredential cloudcredential, String region, String metricName, Date startTime, Date endTime,
    ...
    public GetMetricStatisticsResult getBucketSize(CloudCredential cloudCredential, String region, Date startTime, Date endTime, String bucketName) {
        ...
        return getAWSMetricResult(cloudCredential, region, METRIC_NAME, startTime, endTime, dimensionList, PERIOD);
    }
